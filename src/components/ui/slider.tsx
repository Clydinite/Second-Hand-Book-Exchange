  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "border border-primary/15 shadow bg-muted-foreground/25 relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5"
        )}
      >
